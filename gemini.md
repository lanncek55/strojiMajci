...
- [ ] **Korak 9:** Naloge 2.1, 2.2 in 2.3 (Osnovne enačbe transformatorja, harmonske komponente, izračun mase bakra) - *Strani 1-3 v PDF-ju*.
- [ ] **Korak 10:** Naloge 2.4 in 2.5 (Trifazni transformatorji, vezave Yz5, preračuni izgub in izkoristek pri spremembi frekvence in napetosti) - *Strani 4-8 v PDF-ju*.
- [ ] **Korak 11:** Naloge 2.6, 2.7 in 2.8 (Fazorski diagrami, nadomestno vezje, paralelno obratovanje transformatorjev) - *Strani 9-13 v PDF-ju*.
- [ ] **Korak 12:** Naloge 2.9, 2.10 in 2.11 (Segrevanje stroja, časovna konstanta in dopustna preobremenitev) - *Strani 14-16 v PDF-ju*.
